...
export const zh_TW: Partial<Record<TranslationKey, string>> = {
  ...
  "entities.quests.q_ledger_first_duty.completion": "八頭野豬，種植地也保住了。很好。這本名冊上的每個名字，都是從你現在站的地方開始的。",
  "entities.quests.q_ledger_first_duty.objectives.0.label": "野豬已剔除",
  "entities.quests.q_ledger_first_duty.text": "你想在東溪掙口飯吃嗎，{playerName}？那就從每位守護都起步的地方開始。西邊草地的野豬已經養得肥滿又無所畏懼，把春耕的種植地都拱翻了。剔除8頭野豬，名冊就會記住你的名字。",
