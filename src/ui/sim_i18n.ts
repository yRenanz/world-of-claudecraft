...
const BASE_DICT: Record<SupportedLanguage, Record<BaseSimMessageKey, string>> = {
  ...
  es: {
    ...
    "aura.mudfinHex": "Embrujo de fangaleta",
  ...
  fr_FR: {
    ...
    "log.channelJoined": "Rejoint le canal : [{channel}]. Tapez /{channel} <message> pour discuter.",
    "log.channelLeft": "Quitte le canal : [{channel}].",
    ...
    "aura.silencingShriek": "Cri réducteur au silence",
  ...
  it_IT: {
    ...
    "log.abilityRankUp": "La tua {name} è migliorata al Rango {rank}.",
  ...
  pt_BR: {
    ...
    "log.abilityRankUp": "Sua habilidade {name} melhorou para o Posto {rank}.",
    ...
    "aura.mudfinHex": "Maldição dos Barbatânia",
  ...
  ru_RU: {
    ...
    "log.tooFarToFollow": "{name} слишком далеко, чтобы следовать.",
    ...
    "presence.noLongerAfk": "Вы больше не отошли от клавиатуры.",
    ...
    "aura.silencingShriek": "Безмолвный визг",
