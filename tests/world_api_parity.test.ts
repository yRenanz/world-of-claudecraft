...
//
// `IWorld` (src/world_api.ts:341-510, 158 members) is the ONE seam render/ui depend
...
// it lands the matching edit here in the SAME commit. The count pins (158 / 41 / 116)
...
// The 158 members of `interface IWorld`, in interface order (world_api.ts:342-509).
...
describe('W1: aggregate IWorld member set equals the disjoint union of the 21 facets', () => {
  ...
  it('the union of the 21 facets equals the pinned 158-member IWORLD_MEMBERS set', () => {
