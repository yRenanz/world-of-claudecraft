...
const EXPECTED_SEND_COUNT = 128; // +Vale Cup queue/practice/sport-move + town-focus commands
const EXPECTED_DISPATCH_COUNT = 137; // +Vale Cup queue/practice/sport-move + town-focus commands
